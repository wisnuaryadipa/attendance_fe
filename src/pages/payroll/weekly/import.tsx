...
const Render = (): JSX.Element => {
    ...
    const handleUploadFile = async () => {
        if(selectedFile.size) {
            ...
            formData.append('datePayment', selectedDate);
    
            const option = {
                url: `${process.env.REACT_APP_URL_API}/api/payroll/weekly/import`,
                data: formData,
                timeout: 0,
    ...
    const result = (
        <>
            ...
            <Panel>
                <PanelHeader>
                    <Typography className="titleForm" variant='h5'>Import Weekly Employees Salary Data</Typography>
                </PanelHeader>
