...
const Render = (): JSX.Element => {
    ...
    const handleUploadFile = async () => {
        if(selectedFile.size) {
            ...
            const option = {
                url: `${process.env.REACT_APP_URL_API}/api/import/master-salary-employee`,
                data: formData,
                timeout: 0,
    ...
    const result = (
        <>
            ...
            <Panel>
                <PanelHeader>
                    <Typography className="titleForm" variant='h5'>Import Salary Employees Master Data</Typography>
                </PanelHeader>
